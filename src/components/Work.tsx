...
function Work(){
    const projects:projectType[]=[
    {
      id: 1,
      name: "Iconhub",
      description: "A clean, powerful icon customizer—browse thousands of icons, tweak every detail, and export in one click.",
      skills: ["Nextjs", "Dexie.js", "Shadcn", "Typescript", "Tailwind CSS"],
      liveLink: "https://icon-hub.vercel.app/",
      githubLink: "https://github.com/atul250603/Iconhub"
    }, 
    {
      id: 2,
      name: "Quizzify",
     ...
     liveLink: "https://quizzify-green.vercel.app/",
